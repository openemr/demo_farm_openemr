...
getRandomThemeTwo () {
    ...
    THEME[54]='style_solar.css'
    THEME[55]='style_solar.css'
    THEME[56]='style_solar.css'
    THEME[57]='style_solar.css'
    THEME[58]='style_solar.css'
    THEME[59]='style_solar.css'
    THEME[60]='style_solar.css'
    THEME[61]='style_solar.css'
    THEME[62]='style_solar.css'
    THEME[63]='style_solar.css'
    THEME[64]='style_solar.css'
    THEME[65]='style_solar.css'
    THEME[66]='style_solar.css'
    THEME[67]='style_solar.css'
    THEME[68]='style_solar.css'
    THEME[69]='style_solar.css'
    THEME[70]='style_solar.css'
    THEME[71]='style_solar.css'
...
do
 ...
 if [ ! -d $OPENEMR/vendor ]; then
  ...
  GITHUB_KEY_COMPOSER=`cat /home/ec2-user/cred/github-key`
