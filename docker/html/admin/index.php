                                            ...
                                            <div class="card card-body">
                                                ...
                                                <div class="row col-xs-12">
                                                    <div class="btn-group-vertical form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_six_b_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Six B Refresh</button>
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_six_c_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Six C Refresh</button>
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_six_d_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Six D Refresh</button>
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_six_e_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Six E Refresh</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card card-body">
                                                ...
                                                <div class="row col-xs-12">
                                                    <div class="btn-group-vertical form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_eight_b_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Eight B Refresh</button>
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_eight_c_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Eight C Refresh</button>
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_eight_d_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Eight D Refresh</button>
                                                        <button type="button" class="btn btn-primary procedure-demo" id="refresh_eight_e_openemr" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Refresh">Eight E Refresh</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
